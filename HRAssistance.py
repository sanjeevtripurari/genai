...
#
# pip install langchain langchain_community langchain_openai python-dotenv streamlit gradio langchain_experimental sentence-transformers langchain_chroma langchainhub unstructured langchain_core faiss-cpu
